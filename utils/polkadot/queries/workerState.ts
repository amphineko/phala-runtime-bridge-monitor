...
const getWorkerState = async (address: AccountId | string, api: ApiPromise): Promise<WorkerInfo | null | undefined> => {
...
export const useWorkerStateQuery = (address: AccountId | string, api?: ApiPromise): UseQueryResult<WorkerInfo> => {
